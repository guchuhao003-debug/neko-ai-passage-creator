package com.wenxi.nekoaipassage.utils;
...
public class GsonUtils {
    ...
    /**
     * 安全地将 JSON 字符串转换为对象，解析失败时返回 null
     * @param json  JSON 字符串
     * @param clazz 目标类型
     * @return  对象实例，失败返回 null
     * @param <T>   泛型类型
     */
    ...
    /**
     * 安全地将 JSON 字符串转换为对象（支持泛型）, 解析失败时返回 null
     *
     * @param json  JSON 字符串
     * @param typeToken TypeToken 类型
     * @return  对象实例，失败返回 null
     * @param <T>   泛型类型
     */
